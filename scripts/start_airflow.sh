...
#Start Scheduler
airflow scheduler -D  --pid $AIRFLOW_BASE/run/scheduler.pid --stdout $AIRFLOW_BASE/logs/scheduler/scheduler.out --stderr $AIRFLOW_BASE/logs/scheduler/scheduler.err --log-file $AIRFLOW_BASE/logs/scheduler/scheduler.log
